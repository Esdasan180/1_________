...
youtube = build('youtube', 'v3', developerKey=keys_1.API_YOUTUBE)
...
def get_channel_videos(url: str):
    ...
    df_videos['view count'] = df_videos['view count'].fillna('0')
    df_videos['comment count'] = df_videos['comment count'].fillna('0')
    df_videos['like count'] = df_videos['like count'].fillna('0')

    df_videos['view count'] = df_videos['view count'].astype(int)
    df_videos['comment count'] = df_videos['comment count'].astype(int)
    df_videos['like count'] = df_videos['like count'].astype(int)
    #df_videos.to_csv('nuevo.csv', index=False)
